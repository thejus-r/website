        ...
        <section className="flex flex-col-reverse md:flex-row gap-8">
          <div>
            ...
            <div className="flex flex-col h-full justify-center gap-4 my-4">
              ...
              <P size={"large"}>
                I got to work with clients such as Microsoft, Herkey,
      ...
      <SectionWrapper>
        <section>
          <div className="flex flex-col gap-2">
            ...
            <DisplaySmall>Awesome projects that I got to work on</DisplaySmall>
          </div>
            ...
            {works.map((work, index) => {
              return (
                <div
                  ...
                  key={index}
                >
                  <div className="w-full h-64 bg-neutral-100"></div>
                  <div className="flex flex-col gap-2">
